...
t1 = SSHOperator(
           ...
           /data/workflows/user_sales_analysis/spark_emr/target/user-sales-analysis-1.0.jar {{var.json.USER_SALES_ANALYSIS_SPARK_CONFIG.appName}}  {{var.json.USER_SALES_ANALYSIS_SPARK_CONFIG.configFile}} {{var.json.USER_SALES_ANALYSIS_SPARK_CONFIG.s3FullDumpPath}}"""
           ,dag=dag)
